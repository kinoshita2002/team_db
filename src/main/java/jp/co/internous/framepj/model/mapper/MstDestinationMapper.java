...
public interface MstDestinationMapper {
	 ...
	 * @return 登録件数
	 */
	@Insert("INSERT INTO mst_destination(user_id,family_name,first_name,tel_number,address,created_at,updated_at)"
			+ "Values (#{userId},#{familyName},#{firstName},#{telNumber},#{address},now(),now())")
